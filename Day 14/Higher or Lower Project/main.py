...
while game_should_continue:
    ...
    guess = input("Who has more follower?Type 'A' OR Type 'B'").lower()
    ...
    if is_correct:
        score += 1
        print(f"You right! and your current score is:{score}")
    else:
        print(f"you lose and your current score is:{score}")
